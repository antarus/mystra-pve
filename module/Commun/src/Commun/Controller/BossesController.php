...
class BossesController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/bosses/list');
        return $oViewModel;
    }
    ...
    public function createAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                return $this->redirect()->toRoute('commun-bosses-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/bosses/create');
    ...
    public function updateAction()
    {
        ...
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/bosses/update');
