 ...
 * @project Mystra
 */
class PersonnagesHasSpecialisationController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    {
        if (!$this->_table) {
            $this->_table = $this->getServiceLocator()->get('\Commun\Table\PersonnagesHasSpecialisationTable');
        }
        return $this->_table;
    }
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/personnages-has-specialisation/list');
        return $oViewModel;
    }
    ...
    {
        $oTable = new \Commun\Grid\PersonnagesHasSpecialisationGrid($this->getServiceLocator(),$this->getPluginManager());
    ...
    public function createAction()
    {
        ...
        if ($oRequest->isPost()) {
            $oEntite = new \Commun\Model\PersonnagesHasSpecialisation();
            ...
            if ($oForm->isValid()) {
                ...
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La personnages-has-specialisation a été créé avec succès."), 'success');
                return $this->redirect()->toRoute('commun-personnages-has-specialisation-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/personnages-has-specialisation/create');
    ...
    public function updateAction()
    {
        ...
        try {
            ...
            if (!$oEntite) {
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("Identifiant de personnages-has-specialisation inconnu."), 'error');
                return $this->redirect()->toRoute('commun-personnages-has-specialisation-list');
            }
        } catch (Exception $ex) {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La personnages-has-specialisation a été modifié avec succès."), 'success');
                return $this->redirect()->toRoute('commun-personnages-has-specialisation-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/personnages-has-specialisation/update');
    ...
    public function deleteAction()
    {
        ...
        $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La personnages-has-specialisation a été supprimé avec succès."), 'success');
        return $this->redirect()->toRoute('commun-personnages-has-specialisation-list');
    }
