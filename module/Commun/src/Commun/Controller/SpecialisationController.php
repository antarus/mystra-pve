 ...
 * @project Mystra
 */
class SpecialisationController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    {
        if (!$this->_table) {
            $this->_table = $this->getServiceLocator()->get('\Commun\Table\SpecialisationTable');
        }
        return $this->_table;
    }
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/specialisation/list');
        return $oViewModel;
    }
    ...
    {
        $oTable = new \Commun\Grid\SpecialisationGrid($this->getServiceLocator(),$this->getPluginManager());
    ...
    public function createAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La specialisation a été créé avec succès."), 'success');
                return $this->redirect()->toRoute('commun-specialisation-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/specialisation/create');
    ...
    public function updateAction()
    {
        ...
        try {
            ...
            if (!$oEntite) {
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("Identifiant de specialisation inconnu."), 'error');
                return $this->redirect()->toRoute('commun-specialisation-list');
            }
        } catch (Exception $ex) {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La specialisation a été modifié avec succès."), 'success');
                return $this->redirect()->toRoute('commun-specialisation-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/specialisation/update');
    ...
    public function deleteAction()
    {
        ...
        $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La specialisation a été supprimé avec succès."), 'success');
        return $this->redirect()->toRoute('commun-specialisation-list');
    }
