 ...
 * @project Mystra
 */
class RaidPersonnageController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    {
        if (!$this->_table) {
            $this->_table = $this->getServiceLocator()->get('\Commun\Table\RaidPersonnageTable');
        }
        return $this->_table;
    }
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/raid-personnage/list');
        return $oViewModel;
    }
    ...
    {
        $oTable = new \Commun\Grid\RaidPersonnageGrid($this->getServiceLocator(),$this->getPluginManager());
    ...
    {
        $oForm = new \Commun\Form\RaidPersonnageForm();//new \Commun\Form\RaidPersonnageForm($this->getServiceLocator());
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                return $this->redirect()->toRoute('commun-raid-personnage-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/raid-personnage/create');
    ...
    public function updateAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La raid-personnage a été modifié avec succès."), 'success');
                return $this->redirect()->toRoute('commun-raid-personnage-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/raid-personnage/update');
    ...
    public function deleteAction()
    {
        ...
        $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La raid-personnage a été supprimé avec succès."), 'success');
        return $this->redirect()->toRoute('commun-raid-personnage-list');
    }
