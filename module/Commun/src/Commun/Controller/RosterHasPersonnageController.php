...
class RosterHasPersonnageController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/roster-has-personnage/list');
        return $oViewModel;
    }
    ...
    public function createAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                return $this->redirect()->toRoute('commun-roster-has-personnage-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/roster-has-personnage/create');
    ...
    public function updateAction()
    {
        ...
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/roster-has-personnage/update');
