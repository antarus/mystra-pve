 ...
 * @project Mystra
 */
class ZoneHasBossesController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    {
        if (!$this->_table) {
            $this->_table = $this->getServiceLocator()->get('\Commun\Table\ZoneHasBossesTable');
        }
        return $this->_table;
    }
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/zone-has-bosses/list');
        return $oViewModel;
    }
    ...
    {
        $oTable = new \Commun\Grid\ZoneHasBossesGrid($this->getServiceLocator(),$this->getPluginManager());
    ...
    public function createAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                return $this->redirect()->toRoute('commun-zone-has-bosses-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/zone-has-bosses/create');
    ...
    public function updateAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La zone-has-bosses a été modifié avec succès."), 'success');
                return $this->redirect()->toRoute('commun-zone-has-bosses-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/zone-has-bosses/update');
    ...
    public function deleteAction()
    {
        ...
        $this->flashMessenger()->addMessage($this->_getServTranslator()->translate("La zone-has-bosses a été supprimé avec succès."), 'success');
        return $this->redirect()->toRoute('commun-zone-has-bosses-list');
    }
