...
class EvenementsController extends \Zend\Mvc\Controller\AbstractActionController
{
    ...
    public function listAction()
    {
        ...
        $oViewModel->setTemplate('commun/evenements/list');
        return $oViewModel;
    }
    ...
    public function createAction()
    {
        ...
        if ($oRequest->isPost()) {
            ...
            if ($oForm->isValid()) {
                ...
                return $this->redirect()->toRoute('commun-evenements-list');
            }
        }
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/evenements/create');
    ...
    public function updateAction()
    {
        ...
        // Pour optimiser le rendu
        $oViewModel = new ViewModel();
        $oViewModel->setTemplate('commun/evenements/update');
