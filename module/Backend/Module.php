...
class Module {
    ...
    public function getConsoleUsage(Console $console) {
        ...
        $usage = array(
            ...
            'cache --clear [--force|-f] [<name>] --by-tag=' => $oTranslator->translate('Supprime le cache par tag'),
            ...
            array('--by-tag=', $oTranslator->translate('Supprime tous les éléments du cache ayant le tag donné')),
