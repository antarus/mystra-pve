...
class ItemRequestTest extends \PHPUnit_Framework_TestCase
{
    public function testClasses()
    {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Items\ClassEntity', $response);
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Items\ItemEntity', $response);
    ...
    public function testFindSet()
    {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Items\ItemSetEntity', $response);
