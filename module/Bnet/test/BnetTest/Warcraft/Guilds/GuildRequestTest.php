...
class GuildRequestTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testAchievements() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Guilds\AchievementEntity', $response);
    ...
    public function testOn() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Guilds\GuildRequest', $request->on('Auchindoun'));
    }
    ...
    public function testFind() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Guilds\GuildEntity', $response);
    ...
    public function testPerks() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Guilds\PerkEntity', $response);
    ...
    public function testRewards() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Guilds\RewardEntity', $response);
