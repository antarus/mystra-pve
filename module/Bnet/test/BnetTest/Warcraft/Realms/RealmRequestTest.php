...
class RealmRequestTest extends \PHPUnit_Framework_TestCase
{
    public function testAll()
    {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Realms\RealmEntity', $response[0]);
    }
    ...
    public function testFindSingle()
    {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Realms\RealmEntity', $response);
    ...
    public function testBattlegroups()
    {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Realms\BattlegroupEntity', $response);
