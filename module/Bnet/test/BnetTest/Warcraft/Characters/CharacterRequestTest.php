...
class CharacterRequestTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testAchievement() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\AchievementEntity', $response);
    ...
    public function testAchievements() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\AchievementCategoryEntity', $response[0]);
    }
    ...
    public function testClasses() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\ClassEntity', $response[0]);
    }
    ...
    public function testOn() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\CharacterRequest', $request->on('Auchindoun'));
    }
    ...
    public function testFind() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\CharacterEntity', $response);
    ...
    public function testRaces() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\RaceEntity', $response[0]);
    }
    ...
    public function testTalents() {
        ...
        $this->assertInstanceOf('\Bnet\Warcraft\Characters\TalentEntity', $response[1]['talents'][0]);
    }
...
//
//        $this->assertInstanceOf('\Bnet\Warcraft\Characters\CharacterEntity', $response[0]);
